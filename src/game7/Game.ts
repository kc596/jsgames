...
export default class Game {
  ...
  constructor (private levels: Level[]) {
    ...
    if (this.garden === null) {
      this.garden = document.createElement("div") as HTMLDivElement;
    }
    this.renderGarden();
    this.handleFood();
    this.setEvents();
  ...
  showScore (): void {
    let points = document.getElementById('points') as HTMLDivElement;
    if (points === null) {
      points = document.createElement("div") as HTMLDivElement;
    }
